...
- Review doc
- Build prototype (hoặc tiếp tục dùng AI studio)

3. Cân nhắc
- Tách SKILL viết SRS và US
- Thêm invest cho viết US
- Thêm skill BABOK vào SKILL_01
- claude/rules/ ==> Tạo rules riêng cho BRD và SRS
- Summarize/plan trước khi viết doc
- Từ doc -> viết ra các màn design cần thiết -> rồi mới dùng SKILL design
- Doc_factory tách ra nhiều stage (scope -> edge case -> đọc LESSON_LEARNT -> review -> publish)
