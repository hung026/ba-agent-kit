...
| ID Luồng | Bước | Lỗi | Error message | Mô tả lỗi |
| :--- | :--- | :--- | :--- | :--- |
| EF-01 | Bước 4 | Định dạng email/tên đăng nhập không hợp lệ | "emai không hợp lệ" | Hiển thị inline |
| EF-02 | Bước 5 | Sai tên đăng nhập hoặc mật khẩu | "Sai tên đăng nhập hoặt mật khẩu" | Hiển thị inline |
| EF-03 | Bước 5 | Tài khoản bị khóa hoặc không hoạt động | "Tài khoản bị vô hiệu hóa" | Hiển thị inline |
| EF-04 | Bước 5 | Dịch vụ xác thực không khả dụng | "Lỗi dịch vụ. Vui lòng thử lại" | Hiển thị toast |
