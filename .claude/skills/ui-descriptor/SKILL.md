...
description: >
  ...
  gửi link Figma, hoặc yêu cầu "mô tả giao diện", "mô tả UI", "liệt kê component", "phân tích màn hình", "describe UI", "UI spec". Kể cả khi user chỉ paste ảnh không nói gì thêm mà ảnh đó rõ ràng là giao diện app/web, hãy kích hoạt skill này.
---
